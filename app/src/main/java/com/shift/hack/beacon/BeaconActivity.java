...
public class BeaconActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final JsonObject beaconJson = new JsonParser().parse(getIntent().getExtras().getString("beacon")).getAsJsonObject();
        ...
        getSupportActionBar().setTitle(beaconJson.get("name").getAsString());
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        ServiceGenerator.createService(ApiClient.class).getTransactionsForBeacon(beaconJson.get("_id").getAsString()).enqueue(new Callback<ResponseBody>() {
            @Override
